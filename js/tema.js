...
export function variablesDeTema() {
  return {
    ...
    [VARS_BRAZOS.pivoteIzqY]: pct(BRAZOS.idle.izq.y),
    [VARS_BRAZOS.pivoteDerX]: pct(BRAZOS.idle.der.x),
    [VARS_BRAZOS.pivoteDerY]: pct(BRAZOS.idle.der.y),
    [VARS_BRAZOS.angulo]: ANGULO_BRAZO + "deg",
    [VARS_BRAZOS.acomodo]: ms(ACOMODO_BRAZO.duracion),
    [VARS_BRAZOS.saludo]: SALUDO_BRAZO.angulo + "deg",
