...
export const grupoBrazoIzq = document.getElementById('brazo-izq-grupo');
export const grupoBrazoDer = document.getElementById('brazo-der-grupo');
export const capaBrazoIzq = document.getElementById('brazo-izq');
...
export const escena = document.getElementById('escena');
export const nodoPiso = document.getElementById('piso');
